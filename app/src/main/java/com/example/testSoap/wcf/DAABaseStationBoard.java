...
public class DAABaseStationBoard extends AttributeContainer implements KvmSerializable
{
    ...
    public DAAEnums.FilterType filterType;
    
    public DAAArrayOfNRCCMessages nrccMessages;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,DAAExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("filterType"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.filterType = DAAEnums.FilterType.fromString(j.toString());
                    }
                }
                else if (obj instanceof DAAEnums.FilterType){
                    this.filterType = (DAAEnums.FilterType)obj;
                }
            }
            return true;
        }
        if (info.name.equals("nrccMessages"))
        {
            ...
            {
                Object j = obj;
                this.nrccMessages = (DAAArrayOfNRCCMessages)__envelope.get(j,DAAArrayOfNRCCMessages.class,false);
            }
            return true;
        }
