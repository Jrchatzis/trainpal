...
public class DAAArrayOfServiceItems extends Vector< DAAServiceItem> implements KvmSerializable
{
    ...
    public void loadFromSoap(Object inObj,DAAExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        for (int i0=0;i0< size;i0++)
        {
            ...
            if (obj!=null && obj instanceof AttributeContainer)
            {
                ...
                DAAServiceItem j1= (DAAServiceItem)__envelope.get(j,DAAServiceItem.class,false);
                add(j1);
            }
        }
}
