...
public class DAAStationBoard extends DAABaseStationBoard implements KvmSerializable
{

    
    public DAAArrayOfServiceItems trainServices;
    
    public DAAArrayOfServiceItems busServices;
    
    public DAAArrayOfServiceItems ferryServices;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,DAAExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("trainServices"))
        {
            ...
            {
                Object j = obj;
                this.trainServices = (DAAArrayOfServiceItems)__envelope.get(j,DAAArrayOfServiceItems.class,false);
            }
            return true;
        }
        if (info.name.equals("busServices"))
        {
            ...
            {
                Object j = obj;
                this.busServices = (DAAArrayOfServiceItems)__envelope.get(j,DAAArrayOfServiceItems.class,false);
            }
            return true;
        }
        if (info.name.equals("ferryServices"))
        {
            ...
            {
                Object j = obj;
                this.ferryServices = (DAAArrayOfServiceItems)__envelope.get(j,DAAArrayOfServiceItems.class,false);
            }
            return true;
        }
