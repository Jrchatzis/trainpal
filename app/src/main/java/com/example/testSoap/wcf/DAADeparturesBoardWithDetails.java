...
public class DAADeparturesBoardWithDetails extends DAABaseStationBoard implements KvmSerializable
{

    
    public DAAArrayOfDepartureItemsWithCallingPoints departures=new DAAArrayOfDepartureItemsWithCallingPoints();
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,DAAExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("departures"))
        {
            ...
            {
                Object j = obj;
                this.departures = (DAAArrayOfDepartureItemsWithCallingPoints)__envelope.get(j,DAAArrayOfDepartureItemsWithCallingPoints.class,false);
            }
            return true;
        }
