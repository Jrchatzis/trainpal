...
public class DAAStationBoardWithDetails_1 extends DAABaseStationBoard implements KvmSerializable
{

    
    public DAAArrayOfServiceItemsWithCallingPoints_1 trainServices;
    
    public DAAArrayOfServiceItemsWithCallingPoints_1 busServices;
    
    public DAAArrayOfServiceItemsWithCallingPoints_1 ferryServices;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,DAAExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("trainServices"))
        {
            ...
            {
                Object j = obj;
                this.trainServices = (DAAArrayOfServiceItemsWithCallingPoints_1)__envelope.get(j,DAAArrayOfServiceItemsWithCallingPoints_1.class,false);
            }
            return true;
        }
        if (info.name.equals("busServices"))
        {
            ...
            {
                Object j = obj;
                this.busServices = (DAAArrayOfServiceItemsWithCallingPoints_1)__envelope.get(j,DAAArrayOfServiceItemsWithCallingPoints_1.class,false);
            }
            return true;
        }
        if (info.name.equals("ferryServices"))
        {
            ...
            {
                Object j = obj;
                this.ferryServices = (DAAArrayOfServiceItemsWithCallingPoints_1)__envelope.get(j,DAAArrayOfServiceItemsWithCallingPoints_1.class,false);
            }
            return true;
        }
