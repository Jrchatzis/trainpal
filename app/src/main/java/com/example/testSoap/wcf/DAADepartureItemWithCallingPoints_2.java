...
public class DAADepartureItemWithCallingPoints_2 extends AttributeContainer implements KvmSerializable
{

    
    public DAAServiceItemWithCallingPoints_2 service;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,DAAExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("service"))
        {
            ...
            {
                Object j = obj;
                this.service = (DAAServiceItemWithCallingPoints_2)__envelope.get(j,DAAServiceItemWithCallingPoints_2.class,false);
            }
            return true;
        }
        return false;
