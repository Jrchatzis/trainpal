...
public class DAAStationBoard_2 extends DAABaseStationBoard implements KvmSerializable
{

    
    public DAAArrayOfServiceItems_2 trainServices;
    
    public DAAArrayOfServiceItems_2 busServices;
    
    public DAAArrayOfServiceItems_2 ferryServices;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,DAAExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("trainServices"))
        {
            ...
            {
                Object j = obj;
                this.trainServices = (DAAArrayOfServiceItems_2)__envelope.get(j,DAAArrayOfServiceItems_2.class,false);
            }
            return true;
        }
        if (info.name.equals("busServices"))
        {
            ...
            {
                Object j = obj;
                this.busServices = (DAAArrayOfServiceItems_2)__envelope.get(j,DAAArrayOfServiceItems_2.class,false);
            }
            return true;
        }
        if (info.name.equals("ferryServices"))
        {
            ...
            {
                Object j = obj;
                this.ferryServices = (DAAArrayOfServiceItems_2)__envelope.get(j,DAAArrayOfServiceItems_2.class,false);
            }
            return true;
        }
