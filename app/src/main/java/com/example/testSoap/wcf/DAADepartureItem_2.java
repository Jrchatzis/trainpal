...
public class DAADepartureItem_2 extends AttributeContainer implements KvmSerializable
{

    
    public DAAServiceItem_2 service;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,DAAExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("service"))
        {
            ...
            {
                Object j = obj;
                this.service = (DAAServiceItem_2)__envelope.get(j,DAAServiceItem_2.class,false);
            }
            return true;
        }
        return false;
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        if(propertyIndex==0)
        {
            info.type = DAAServiceItem_2.class;
            info.name = "service";
