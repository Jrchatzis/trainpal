...
public class DAADeparturesBoardWithDetails_1 extends DAABaseStationBoard implements KvmSerializable
{

    
    public DAAArrayOfDepartureItemsWithCallingPoints_1 departures=new DAAArrayOfDepartureItemsWithCallingPoints_1();
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,DAAExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("departures"))
        {
            ...
            {
                Object j = obj;
                this.departures = (DAAArrayOfDepartureItemsWithCallingPoints_1)__envelope.get(j,DAAArrayOfDepartureItemsWithCallingPoints_1.class,false);
            }
            return true;
        }
