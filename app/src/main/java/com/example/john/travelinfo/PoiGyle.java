...
public class PoiGyle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView food =(TextView)findViewById(R.id.GyleFood);
        ...
        TextView coffee =(TextView)findViewById(R.id.GyleCoffee);
        ...
        TextView shops =(TextView)findViewById(R.id.GyleShops);
        ...
        TextView fun =(TextView)findViewById(R.id.GyleFun);
        ...
        TextView nightlife =(TextView)findViewById(R.id.GyleNighlife);
