...
public class DAADeparturesBoard_2 extends DAABaseStationBoard implements KvmSerializable
{

    
    public DAAArrayOfDepartureItems_2 departures=new DAAArrayOfDepartureItems_2();
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,DAAExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("departures"))
        {
            ...
            {
                Object j = obj;
                this.departures = (DAAArrayOfDepartureItems_2)__envelope.get(j,DAAArrayOfDepartureItems_2.class,false);
            }
            return true;
        }
