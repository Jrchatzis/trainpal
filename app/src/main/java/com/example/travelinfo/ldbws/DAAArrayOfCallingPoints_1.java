...
public class DAAArrayOfCallingPoints_1 extends AttributeContainer implements KvmSerializable
{

    
    public ArrayList< DAACallingPoint_1> callingPoint =new ArrayList<DAACallingPoint_1 >();
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,DAAExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("callingPoint"))
        {
            if(obj!=null)
            {
                ...
                {
                    this.callingPoint = new ArrayList< DAACallingPoint_1>();
                }
                Object j =obj;
                DAACallingPoint_1 j1= (DAACallingPoint_1)__envelope.get(j,DAACallingPoint_1.class,false);
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        if(propertyIndex>=0 && propertyIndex < 0+this.callingPoint.size())
        {
            info.type = DAACallingPoint_1.class;
