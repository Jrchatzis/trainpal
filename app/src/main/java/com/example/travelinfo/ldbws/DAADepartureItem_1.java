...
public class DAADepartureItem_1 extends AttributeContainer implements KvmSerializable
{

    
    public DAAServiceItem_1 service;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,DAAExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("service"))
        {
            ...
            {
                Object j = obj;
                this.service = (DAAServiceItem_1)__envelope.get(j,DAAServiceItem_1.class,false);
            }
            return true;
        }
        return false;
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        if(propertyIndex==0)
        {
            info.type = DAAServiceItem_1.class;
            info.name = "service";
