...
public class DAADeparturesBoard extends DAABaseStationBoard implements KvmSerializable
{

    
    public DAAArrayOfDepartureItems departures=new DAAArrayOfDepartureItems();
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,DAAExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("departures"))
        {
            ...
            {
                Object j = obj;
                this.departures = (DAAArrayOfDepartureItems)__envelope.get(j,DAAArrayOfDepartureItems.class,false);
            }
            return true;
        }
