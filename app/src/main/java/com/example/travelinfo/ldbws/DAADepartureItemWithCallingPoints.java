...
public class DAADepartureItemWithCallingPoints extends AttributeContainer implements KvmSerializable
{

    
    public DAAServiceItemWithCallingPoints service;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,DAAExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("service"))
        {
            ...
            {
                Object j = obj;
                this.service = (DAAServiceItemWithCallingPoints)__envelope.get(j,DAAServiceItemWithCallingPoints.class,false);
            }
            return true;
        }
        return false;
