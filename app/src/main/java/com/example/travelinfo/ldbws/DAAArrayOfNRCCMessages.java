...
public class DAAArrayOfNRCCMessages extends Vector< DAANRCCMessage> implements KvmSerializable
{
    ...
    public void loadFromSoap(Object inObj,DAAExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        for (int i0=0;i0< size;i0++)
        {
            ...
            if (obj!=null && obj instanceof AttributeContainer)
            {
                ...
                DAANRCCMessage j1= (DAANRCCMessage)__envelope.get(j,DAANRCCMessage.class,false);
                add(j1);
            }
        }
}
